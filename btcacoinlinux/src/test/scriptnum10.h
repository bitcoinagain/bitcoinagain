...
#ifndef BITCOINAGAIN_TEST_SCRIPTNUM10_H
#define BITCOINAGAIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcoinagain Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINAGAIN_TEST_BIGNUM_H
