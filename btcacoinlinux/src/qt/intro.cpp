...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/bitcoinagain"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoinagain Core"),
     ...
     * override -datadir in the bitcoinagain.conf file in the default data directory
     * (to be consistent with bitcoinagaind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
