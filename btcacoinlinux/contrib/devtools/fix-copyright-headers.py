...
// Copyright (c) 2009-2012 The Bitcoinagain Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Bitcoinagain/$1-%s The Bitcoinagain/' %s"
REGEX_CURRENT= re.compile("%s The Bitcoinagain" % year)
