Bitcoinagain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinagain/files/Bitcoinagain/bitcoinagain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcoinagain
...
New/changed settings (command-line or bitcoinagain.conf file)
--------------------------------------------------------
