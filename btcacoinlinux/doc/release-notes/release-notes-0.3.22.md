Download URL: https://sourceforge.net/projects/bitcoinagain/files/Bitcoinagain/bitcoinagain-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTCA fee schedule (users still pay 0.01 BTCA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinagain00 - #bitcoinagain99
