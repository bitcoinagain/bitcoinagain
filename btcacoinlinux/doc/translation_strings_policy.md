...
This document provides guidelines for internationalization of the Bitcoinagain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinagain_en.ts` remains unchanged.
