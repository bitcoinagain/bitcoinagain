Bitcoinagain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinagain/files/Bitcoinagain/bitcoinagain-0.5.4/
...
http://gitorious.org/bitcoinagain/bitcoinagaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcoinagain-Qt notifications under Growl 1.3.
Increase required age of Bitcoinagain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinagain properly when installing Bitcoinagain-Qt over it. (Windows)
