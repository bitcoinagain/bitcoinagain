Bitcoinagain Core version 0.9.4 is now available from:

  https://bitcoinagain.org/bin/0.9.4/
...
this update is incompatible with the Bitcoinagain system and could lead to consensus
forks.

Bitcoinagain Core released binaries from https://bitcoinagain.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinagain/+archive/ubuntu/bitcoinagain
- A third-party or self-compiled Bitcoinagain Core

upgrade to Bitcoinagain Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
