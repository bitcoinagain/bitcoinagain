Bitcoinagain Core version 0.9.2.1 is now available from:

  https://bitcoinagain.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTCA to 0.01 BTCA
...
- Fix "Start bitcoinagain on system login"
