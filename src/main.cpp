...
#if defined(NDEBUG)
# error "Bitcoinagain cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bitcoinagain Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s BTCA additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("bitcoinagain-scriptch");
