// Copyright (c) 2013-2015 The Bitcoinagain Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CBitcoinagainAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CBitcoinagainAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CBitcoinagainAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CBitcoinagainAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CBitcoinagainAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBitcoinagainAddress(arr[0].get_str()).Get() == demoAddress.Get());
